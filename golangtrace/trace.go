...
import (
	...
	"github.com/zxfonline/gotrace/golangtrace/timeseries"
)
...
var AuthRequest = func(req *http.Request) (any bool) {
...
func (tr *trace) Finish() time.Duration {
	...
	f := getFamily(tr.Family, true, false)
